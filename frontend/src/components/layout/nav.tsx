...
function ProfileMenu() {
  ...
  const menuLinks = [
    ...
    { href: '/requests', label: t('nav.requests'), icon: Megaphone },
    { href: '/works', label: t('nav.works'), icon: Camera },
    { href: '/designs', label: t('nav.designs'), icon: Palette },
    { href: '/catering', label: t('nav.catering'), icon: UtensilsCrossed },
    { href: '/services', label: t('nav.services'), icon: Music },
    { href: '/flowers', label: t('nav.flowers'), icon: Flower2 },
